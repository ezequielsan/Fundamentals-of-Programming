...
void printFazParte(int state) {
  if(state == 1) {
    printf("O vetor B faz parte de A\n");
  }
  else {
    printf("O vetor B nao faz parte\n");
  }
}
...
int main() {
  ...
  // slice(2, array2, tamanho[0], aux, 2);

  state = vetorParte(array, array2, tamanho);
